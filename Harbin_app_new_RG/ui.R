shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      em("Bester R, Pepler PT, Aldrich DJ and Maree HJ (2017) Harbin: A quantitation PCR analysis tool. Biotechnol Letters 39:171–178. DOI 10.1007/s10529-016-2221-1."),
      br(),
      br(),
