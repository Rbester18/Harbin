shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      em("Bester, R, Pepler, PT and Maree, HJ. (2016). Harbin: An analysis tool for relative quantitation of real-time qPCR data and a quantile-based bootstrap test for data pooling."),
      br(),
      br(),
