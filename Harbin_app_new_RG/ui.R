shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      em("Bester, R, Pepler, PT, Burger, JT. and Maree, HJ. (2016). Harbin: An analysis tool for relative quantita-tion of real-time qPCR data and a quantile-based bootstrap test for data pooling."),
      br(),
      br(),
