shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      img(src = "Harbin_new.jpg", height = 400, width = 400),
      br(),
      br(),
      p("Relative quantitation data analysis tool for real-time qPCR data."),
      br(),
      ...
      em("Bester, R, Pepler, PT, Burger, JT. and Maree, HJ. (2016)."),
      br(),
      br(),
      img(src = "Vitis_logo.jpg", height = 60, width = 103),
      "Harbin is a product from the ", 
      a("Vitis laboratory", href="http://www.sun.ac.za/english/faculty/agri/genetics/research/plant-genetics"),
      br(),
      p("For more information please contact Dr. H.J. Maree at hjmaree@sun.ac.za"),
      br(),
