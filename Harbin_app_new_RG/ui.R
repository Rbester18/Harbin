shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      em("Bester, R, Pepler, PT, Aldrich, DJ and Maree, HJ. (2016). Relative quantitation of grapevine leafroll-associated virus 3 genetic variants using a quantile-based bootstrap test for combining data."),
      br(),
      br(),
                    ...
                    navlistPanel("Compare to reference data set",
                      tabPanel(h4("Rotor-Gene data import comparison"), 
                          ...
                          radioButtons("Database_add", "Add new data to reference data set file?", 
                                       choices = list("Yes" = 1, "No" = 2), selected=2),
                          h5("Download normalised gene of interest(GOI) data and new reference data set (if applicable)"),
