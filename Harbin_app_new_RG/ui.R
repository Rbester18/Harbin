shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  sidebarLayout(
    sidebarPanel(
      ...
      em("Bester R, Pepler PT, Aldrich DJ and Maree HJ (2017) Harbin: A quantitation PCR analysis tool. Biotechnology Letters 39:171–178. DOI 10.1007/s10529-016-2221-1."),
      br(),
      br(),
    ...
    mainPanel(
      tabsetPanel(tabPanel(h5("Data upload"),
                 ...
                 tabPanel(h5("Data distribution"),
                          ...
                          br(),
                          h5("Group differential expression: Log2(fold change)"),
                          verbatimTextOutput("logchanges"),
                          br(),
