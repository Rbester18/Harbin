shinyUI(fluidPage(theme = "bootstrap.css",
  ...
  titlePanel("Welcome to Harbin"),
  
  sidebarLayout(
    sidebarPanel(
      br(),
      p("Data analysis for reverse transcription PCR (RT-qPCR) relative quantification data."),
      br(),
      img(src = "harbin.jpg", height = 400, width = 400),
      br(),
      br(),
      ...
      br(),
      br(),
      p("Please cite if you use the application:"),
      p("Bester, R, Pepler, PT, Burger, JT. and Maree, HJ. (2016)."),
      br(),
      p("For more information please contact Hano Maree at hjmaree@sun.ac.za"),
      br(),
      br(),
      em("'Robert Harbin (1908 - 1978), born in South Africa, was a British magician and the inventor of a number of classic illusions, including the Zig Zag Girl. Since the the qPCR concentrations are devided into intervals, we decided to name our application ", span("Harbin", style = "color:#dd4814"), "'")
    ),
    
    mainPanel(
      tabsetPanel(tabPanel(h5("Data upload"),
                 navlistPanel("Import data",
                  tabPanel(h5("Rotorgene data import"),
                      ...
                      navbarMenu("--> Rotorgene data output",
                 ...
                 tabPanel(h5("Harbin intervals"),
                    navlistPanel("Database comparison",
                      tabPanel(h4("Rotorgene data import comparison"), 
                      ...
                      navbarMenu(h6("--> RotorGene import: View reference database"),
                  ...
                  tabPanel(h4("Interval visualisation"),
                           ...
                           radioButtons("Input_type", "Rotorgene or manual input?", 
                                        choices = list("Rotorgene input" = 1, "Manual input" = 2), selected=1),
                 ...
                 tabPanel(h5("Group selection"),
                          ...
                          helpText(em("Normalised data: Data from Rotorgene/manual input")), 
                          helpText(em("New reference database: Data from Rotorgene/manual input if option was selected to add data to reference database")),
